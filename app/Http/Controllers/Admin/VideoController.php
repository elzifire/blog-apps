...
class VideoController extends Controller
{
    ...
    {
        $videos = VideoF::latest()->when(request()->q, function($videos) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(VideoF $video)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, VideoF $video)
    {
        $this->validate($request, [
            // 'title' => 'required',
            'embed' => 'required'
        ...
        $video = VideoF::findOrFail($video->id);
        $video->update([
            // 'title' => $request->input('title'),
            'embed' => $request->input('embed')
        ]);
