...
<head>
    ...
    <title>Dashboard &mdash; Portal Berita</title>
...
<body style="background: #e2e8f0">
    <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v18.0" nonce="LDBffnTS"></script>
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('admin.dashboard.index') }}">Portal Berita</a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">   
                    Copyright &copy; 2023<div class="bullet"></div> Portal Berita <div class="bullet"></div> All Rights
                    Reserved.
                </div>
...
$(document).ready(function () {
        $('#tag').on('change', function () {
            // Dapatkan semua opsi yang dipilih
            var selectedOptions = $('#tag').val();
            ...
            // Tambahkan tanda centang ke opsi yang dipilih
            if (selectedOptions) {
                $.each(selectedOptions, function (index, value) {
                    $('option[value="' + value + '"]').text('✓ ' + $('option[value="' + value + '"]').text());
                });
            }
        });
    });
