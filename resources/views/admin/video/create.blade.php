                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.video.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label>EMBED Facebook</label>
                                <input type="text" name="embed" value="{{ old('embed') }}" placeholder="Masukkan Embed Facebook" class="form-control @error('embed') is-invalid @enderror">
